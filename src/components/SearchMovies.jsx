...
function SearchMovies(){
	...
	let [ pelicula, setMovies ] = useState([]);
	...
	// Credenciales de API
	const apiKey = 'https://www.omdbapi.com/?s=batman&apikey=e24ea09d';
				...
				<>
					...
					<div className="row">
						...
						{/* Listado de películas */}
						{
							...
							pelicula.length > 0 && pelicula.map((movie, i) => {
								return (
					...
					{ pelicula.length === 0 && <div className="alert alert-warning text-center">No se encontraron películas</div>}
				</>
				:
